  ...
  return (
    <div className="min-h-dvh flex flex-col bg-white">
      {step !== "result" && step !== "processing" && (
        <ServiceHeader title={headerTitle[step] || "Telkom/IndiHome"} onBack={handleBack} />
      )}
      ...
      {step === "input" && (
        <div className="flex-1 px-5 pt-6">
          <IdNumberInput
            ...
            error={error}
            icon={<Phone size={18} className="text-[var(--color-text-secondary)]" />}
          />
          <button
