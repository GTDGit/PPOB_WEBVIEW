  ...
  return (
    <div className="min-h-dvh flex flex-col bg-white">
      {step !== "result" && step !== "processing" && (
        <ServiceHeader title={headerTitle[step] || "Tagihan Gas (PGN)"} onBack={handleBack} />
      )}
      ...
      {step === "input" && (
        <div className="flex-1 px-5 pt-6">
          <IdNumberInput
            ...
            error={error}
            icon={<Flame size={18} className="text-[var(--color-text-secondary)]" />}
          />
          <button
...
export default function TagihanGasPage() {
  return (
