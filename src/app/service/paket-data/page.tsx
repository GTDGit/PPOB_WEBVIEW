  ...
  return (
    <div className="min-h-dvh flex flex-col bg-white">
      {step !== "result" && step !== "processing" && (
        <ServiceHeader title={headerTitle[step] || "Paket Data"} onBack={handleBack} />
      )}
      ...
      {step === "confirm" && orderData && (
        ...
        >
          <div className="p-4 rounded-xl bg-[var(--color-accent-soft)] mb-4">
            <p className="text-sm text-[var(--color-text-secondary)]">Paket</p>
      ...
      {step === "result" && (
        <TransactionResult
          ...
          receiptRows={
            result
              ? [
                  { label: "Paket", value: result.product.name },
